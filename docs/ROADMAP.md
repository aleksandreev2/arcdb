...
parser-based EPUB HTML sanitization, upload/session ownership/path confinement and
nonce-based executable-script CSP are implemented in repository/local/CI. The
